using Com.BatikSolo.Service.Auth.Lib.BusinessLogic.Services;
using Com.BatikSolo.Service.Auth.Lib.Models;
using Com.BatikSolo.Service.Auth.Lib.Utilities.BaseClass;
using System;
...
namespace Com.BatikSolo.Service.Auth.Lib.ViewModels
{
